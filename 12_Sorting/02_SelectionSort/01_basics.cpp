...
// UNSTABLE SORT => it does not maintain the relative order of the equal elements in the sorted array as we are swapping the minimum element with the first element of the unsorted array in each pass
